...
#define MRB_EXTRACT_DEV(obj, dev) ((mrb_filestat_data *)DATA_PTR(obj))->stat->st_##dev

#define MRB_EXTRACT_MODE(obj) ((mrb_filestat_data *)DATA_PTR(obj))->stat->st_mode

#define MRB_EXTRACT_TIME(obj, tim) ((mrb_filestat_data *)DATA_PTR(obj))->stat->st_##tim
...
static mrb_value mrb_filestat_is_directory(mrb_state *mrb, mrb_value self) {
